...
function hyori_woocommerce_get_ajax_products() {
    ...
    $layout_input = isset($settings['layout_type']) ? sanitize_text_field($settings['layout_type']) : '';
    $allowed_layouts = ['grid', 'carousel'];
    $layout_type = in_array($layout_input, $allowed_layouts) ? $layout_input : 'grid';
