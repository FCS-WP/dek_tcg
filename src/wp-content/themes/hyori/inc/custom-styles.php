...
if ( !function_exists ('hyori_custom_styles') ) {
	function hyori_custom_styles() {
		...
		?>
			...
			<?php if ( hyori_get_config('button_cart_color') != "" ) : ?>
				.product-block.grid .add-cart a.button, .product-block.grid .add-cart a.added_to_cart,
				.shop-list-normal.shop-deal-list .add-cart a.button, .shop-list-normal.shop-deal-list .add-cart a.added_to_cart {
					color:<?php echo esc_html( hyori_get_config('button_cart_color') ) ?> !important;
				}

			<?php endif; ?>

			<?php if ( hyori_get_config('button_cart_hv_color') != "" ) : ?>
				...
				.shop-list-normal.shop-deal-list .add-cart a.button:hover, .shop-list-normal.shop-deal-list .add-cart a.added_to_cart:hover{
					color:<?php echo esc_html( hyori_get_config('button_cart_hv_color') ) ?> !important;
				}

			<?php endif; ?>


			<?php if ( hyori_get_config('bg_button_cart_color') != "" ) : ?>
				.product-block.grid .add-cart a.button, .product-block.grid .add-cart a.added_to_cart,
				.shop-list-normal.shop-deal-list .add-cart a.button, .shop-list-normal.shop-deal-list .add-cart a.added_to_cart {
					background-image: linear-gradient(to right, <?php echo esc_html( hyori_get_config('bg_button_cart_color_2') ) ?>, <?php echo esc_html( hyori_get_config('bg_button_cart_color') ) ?>, #ffaa00);
				}

			<?php endif; ?>

			<?php if ( hyori_get_config('bg_button_cart_color_2') != "" ) : ?>

				.product-block.grid .add-cart a.button:hover, .product-block.grid .add-cart a.added_to_cart:hover,
				.shop-list-normal.shop-deal-list .add-cart a.button:hover, .shop-list-normal.shop-deal-list .add-cart a.added_to_cart:hover {
					background-image: linear-gradient(to right, <?php echo esc_html( hyori_get_config('bg_button_cart_color') ) ?>, <?php echo esc_html( hyori_get_config('bg_button_cart_color_2') ) ?>, #ffaa00);
				}
