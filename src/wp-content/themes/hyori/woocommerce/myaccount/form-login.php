	...
	<div id="customer_login_<?php echo esc_attr($rand_id); ?>" class="register_login_wrapper <?php echo trim($action == '#customer_login' ? 'active' : ''); ?>">
		...
		<form method="post" class="login" role="form">
			...
			<p class="form-group form-row-wide">
				<label for="username" class="for-control"><?php esc_html_e( 'Username or Email', 'hyori' ); ?> <span class="required">*</span></label>
			...
			<p class="form-group form-row-wide">
				<label for="password" class="for-control"><?php esc_html_e( 'Password', 'hyori' ); ?> <span class="required">*</span></label>
			...
			<div class="form-group">
				...
				<input type="submit" class="btn btn-theme" name="login" value="<?php esc_html_e( 'LOG IN', 'hyori' ); ?>" />
			</div>
		...
		<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
			<div class="create text-center">
				<?php echo esc_html__('No account yet?','hyori') ?> <a class="creat-account register-login-action" href="#customer_register_<?php echo esc_attr($rand_id); ?>"> <?php echo esc_html__('Create an account','hyori'); ?></a>
			</div>
		<?php endif; ?>
	...
	<div id="customer_register_<?php echo esc_attr($rand_id); ?>" class="content-register register_login_wrapper <?php echo trim($action == '#customer_register' ? 'active' : ''); ?>">
		...
		<form method="post" class="register widget" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
				...
				<p class="form-group form-row-wide">
					<label for="reg_username" class="for-control"><?php esc_html_e( 'Username', 'hyori' ); ?> <span class="required">*</span></label>
			...
			<p class="form-group form-row-wide">
				<label for="reg_email" class="for-control"><?php esc_html_e( 'Email address', 'hyori' ); ?> <span class="required">*</span></label>
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
				...
				<p class="form-group form-row-wide">
					<label for="reg_password" class="for-control"><?php esc_html_e( 'Password', 'hyori' ); ?> <span class="required">*</span></label>
			...
			<p class="form-group wrapper-submit">
				...
				<button type="submit" class="btn btn-theme" name="register" value="<?php esc_attr_e( 'Register', 'hyori' ); ?>"><?php esc_html_e( 'REGISTER', 'hyori' ); ?></button>
			</p>
		...
		<div class="create text-center">
			<?php echo esc_html__('Have an Account.','hyori') ?> <a class="login-account register-login-action" href="#customer_login_<?php echo esc_attr($rand_id); ?>"> <?php echo esc_html__('Login','hyori'); ?></a>
		</div>
